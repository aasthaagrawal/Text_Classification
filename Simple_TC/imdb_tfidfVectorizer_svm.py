...
print("Accuracy of text classification for imdb dataset: {:.2f}".format(accuracy*100))				#Obtained accuracy = 86.64%

ypred = model.predict(train_features)
accuracy = accuracy_score(train_data["sentiment"], ypred)
print("Accuracy of text classification for imdb dataset: {:.2f}".format(accuracy*100))				#Obtained accuracy = 99.26%